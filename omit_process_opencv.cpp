...
cv::Mat COmitProcessOpenCV::Run(const Json::Value& recipe,
...
cv::Mat COmitProcessOpenCV::GetDefaultRegion(const cv::Mat& imageInput,
...
cv::Mat COmitProcessOpenCV::GetStdDevImage(const Json::Value& recipe, const cv::Mat& imageInput) const
{
    const cv::Mat gray = ensureGray8(imageInput);
...
cv::Mat COmitProcessOpenCV::GetStdDevFilter(const Json::Value& recipe,
                                            const cv::Mat& imageInput,
...
cv::Mat COmitProcessOpenCV::GetStdDevFilterFillup(const Json::Value& recipe, const cv::Mat& regionInput) const
{
...
cv::Mat COmitProcessOpenCV::GetEnhanceOmitFilter(const Json::Value& recipe,
                                                 const cv::Mat& imageInput,
...
cv::Mat COmitProcessOpenCV::GetSelectedRegion(const Json::Value& recipe,
                                              const cv::Mat& imageInput,
...
cv::Mat COmitProcessOpenCV::GetEnhanceOmitFilterConcat(const cv::Mat& regionInput,
                                                       const cv::Mat& selectedRegion) const
{
    return unionMask(regionInput, selectedRegion);
}

cv::Mat COmitProcessOpenCV::GetOmitImage(const cv::Mat& regionTotalRoi,
                                         const cv::Mat& imageInput,
                                         const cv::Mat& selectedRegion,
...
cv::Mat COmitProcessOpenCV::GetSharedSelectedRegion(const Json::Value& recipe,
                                                    const cv::Mat& imageInput,
                                                    const cv::Mat& regionTotalRoi) const
{
    cv::Mat intersect;
...
cv::Mat COmitProcessOpenCV::GetInspectionRoi(const Json::Value& recipe, const cv::Mat& srcImage) const
{
...
void COmitProcessOpenCV::CalcOmitDefectData(const cv::Mat& omitInspRoi,
